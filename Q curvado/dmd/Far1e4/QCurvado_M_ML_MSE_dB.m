...
loadname = strcat("ARX_Curvado_txd2M64x64_Rxd12dmd_D10000.mat");
...
resname = strcat('FAR_ARX_MMSE_ML_A16(si)_Curvado_txd2M64x64_Rxd12dmd_P30,40,50,60,70_D',nom_corba);
save(resname,"BER_ML","BER_MSE");    
end