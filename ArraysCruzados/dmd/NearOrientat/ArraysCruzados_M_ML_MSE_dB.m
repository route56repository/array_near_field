...
loadname = strcat("ARXO_Cruzados_txd2M64x64_rxdRx12dmd_dRx16_D",nom_corba,".mat");
...
resname = strcat('ARXO_Cruzados_A16_txd2M64x64_rxdRx12dmd_dRx16_P20,30_D',nom_corba);
save(resname,"BER_ML","BER_MSE");    
end