...
loadname = strcat("ARX_Cruzados_txd2M64x64_rxdRx12dmd_dRx16_D",nom_corba,".mat");
...
resname = strcat('ARX_Cruzados_A16_txd2M64x64_rxdRx12dmd_dRx16_P20,30,40,50,60_D',nom_corba);
save(resname,"BER_ML","BER_MSE");    
end