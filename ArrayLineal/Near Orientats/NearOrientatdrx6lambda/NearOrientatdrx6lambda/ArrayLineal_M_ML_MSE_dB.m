...
Errors_ML = zeros(sectors,repeticiones,length(P));
seq_recibida_MSE = zeros(sectors, repeticiones);
Errors_MSE = zeros(sectors, repeticiones,length(P));
...
loadname = strcat("ARXO_txd2M64x64_rxdRx6ldmd_dRx16_D",nom_corba,".mat");
...
resname = strcat('ARXO_ArrayLineal_A16_txMd2_rxd6lam_dmd16_ML_MSE_20,30_D',nom_corba);
save(resname,"BER_ML","BER_MSE");    
end